    ...
    return (
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 md:gap-x-5 gap-y-6 md:gap-y-0 mt-10 mx-1 md:mx-10' data-aos="fade-up"   data-aos-duration="3000">
            <div className='text-black bg-slate-300 text-center border'>
                <p className='text-[20px] md:text-[32px] -mt-5 border-4 text-white rounded-[50%] mx-[130px]  md:mx-[140px] bg-blue-800 border-white   p-[10px] justify-center flex '><BsEmojiSmile/></p>
           ...
           <p className='md:mt-3  md:text-lg mb-3 md:mb-2 ml-5'>Happy CLiets</p>
            ...
            <div className='text-black bg-slate-300 text-center border'>
                <p className='text-[20px] md:text-[32px] -mt-5 border-4 text-white rounded-[50%] mx-[130px]  md:mx-[140px] bg-blue-800 border-white   p-[10px] justify-center flex '><BsFillFileTextFill/></p>
           ...
           <p className='md:mt-3  md:text-lg mb-3 md:mb-2 ml-5'>Project</p>
            ...
            <div className='text-black bg-slate-300 text-center border'>
                <p className='text-[20px] md:text-[32px] -mt-5 border-4 text-white rounded-[50%] mx-[130px]  md:mx-[140px] bg-blue-800 border-white   p-[10px] justify-center flex  '><BsHeadset/></p>
           ...
           <p className='md:mt-3  md:text-lg mb-3 md:mb-2 ml-5'>Our of Suppert</p>
            ...
            <div className='text-black bg-slate-300 text-center border'>
                <p className='text-[20px] md:text-[32px] -mt-5 border-4 text-white rounded-[50%] mx-[130px]  md:mx-[140px] bg-blue-800 border-white   p-[10px] justify-center flex  '><RiGroupLine/></p>
